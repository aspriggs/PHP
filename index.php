...
<?php 
	$stock = "SELECT * FROM tblproduct WHERE stock >= 1 ORDER BY id DESC";
	$sold = "SELECT * FROM tblproduct WHERE stock = 0 ORDER BY id DESC";
?>
	<section><?php require ("stock.php");?></section>
